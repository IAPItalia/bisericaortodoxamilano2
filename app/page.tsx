  ...
  return (
    <main className="relative bg-[#fdfcf9]">
      ...
      <div className="sr-only" aria-hidden="true">
        <h2>Biserica Românească la Milano - Biserica Ortodoxă Română Milano 2</h2>
        <p>
          Sunteți în căutarea unei biserici românești la Milano? Parohia Ortodoxă Română Milano 2, cu hramul Sfinții Mucenici Nazarie, Ghervasie, Protasie și Chelsie, vă așteaptă cu drag. 
        ...
        <p>
          ...
          sfintii mucenici nazarie milano, pr stefan catalin andronache, program slujbe milano, biserica ortodoxa milano, slujbe in limba romana milano, 
